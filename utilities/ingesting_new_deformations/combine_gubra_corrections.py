...
nib.save(nib.Nifti1Image(out_arr, np.eye(4)), f"/home/harryc/github/CCF_translator/CCF_translator_local/metadata/deformation_fields/allen_mouse/allen_mouse_pull_perens_stpt_mouse.nii.gz")
