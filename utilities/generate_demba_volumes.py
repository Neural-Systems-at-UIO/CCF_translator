...
for end_age in range(t_start_age, youngest_age-1,  -1):
    ...
    CCFT_vol.transform(end_age, 'demba_dev_mouse')
    CCFT_vol.save(rf"{save_path}/P{end_age}_kim_annotation_{voxel_size_micron}um.nii.gz")
...
for end_age in range(t_start_age, youngest_age-1,  -1):
    ...
    CCFT_vol.transform(end_age, 'demba_dev_mouse')
    CCFT_vol.save(rf"{save_path}/P{end_age}_allen_2022_annotation_{voxel_size_micron}um.nii.gz")
