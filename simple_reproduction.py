...
#open deformation 
#transform_path = r"/home/harryc/github/CCF_translator/CCF_translator/metadata/deformation_fields/allen_mouse_CCF/P56_to_P28.hdf5"
...
deformation = open_transformation_nii(transform_path) / 28
#transform volume
out_file = apply_transform(seg_arr, deformation * 14)

img = nib.Nifti1Image(out_file, seg_img.affine, header=seg_img.header)
nib.save(img, f"demo_data/DeMBA_P{target}_simple_repro_rev.nii.gz")
